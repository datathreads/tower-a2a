...
### AgentCard
The root discovery document, served at `/.well-known/agent-card.json`.
...
- `message`: ([Message](#message), optional) Status explanation or additional context (NOT a plain string).
...
- `method`: (string) RPC method name (see [Operations](#4-operations)).
...
| :--- | :--- | :--- | :--- |
| `message/send` | Send a message, get a task or message | `MessageSendParams` | `Task \| Message` |
| `message/stream` | Send a message with SSE streaming | `MessageSendParams` | SSE stream of events |
| `tasks/get` | Retrieve a task by ID | `TaskQueryParams` | `Task` |
| `tasks/cancel` | Cancel a task | `TaskIdParams` | `Task` |
| `tasks/resubscribe` | Re-subscribe to task SSE stream | `TaskIdParams` | SSE stream |
| `tasks/pushNotificationConfig/set` | Set push notification config | `TaskPushNotificationConfig` | `TaskPushNotificationConfig` |
| `tasks/pushNotificationConfig/get` | Get push notification config | `GetTaskPushNotificationConfigParams` | `TaskPushNotificationConfig` |
| `tasks/pushNotificationConfig/list` | List push notification configs | `ListTaskPushNotificationConfigParams` | Array of `TaskPushNotificationConfig` |
| `tasks/pushNotificationConfig/delete` | Delete push notification config | `DeleteTaskPushNotificationConfigParams` | (empty) |
| `agent/getAuthenticatedExtendedCard` | Get extended agent card (authenticated) | (none) | `AgentCard` |
